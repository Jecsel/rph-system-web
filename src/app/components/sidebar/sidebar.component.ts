...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/nurse-list', title: 'AOP',  icon:'local_pharmacy', class: '' },
    { path: '/doctor-list', title: 'AOP Forms',  icon:'medical_services', class: '' },
    { path: '/patient-list', title: 'Reports',  icon:'person', class: '' },
    { path: '/admin-list', title: 'Admins',  icon:'admin_panel_settings', class: '' },
    ...
    { path: '/about-us', title: 'About Us',  icon:'notifications', class: '' },
